...
static const char keywords[][21] = {
    "with", "parameters", "end", "while", "union", "endunion", "definetype", "as", "type", "global", "parameter", "list", "input", "output", "int", "real", "if", "endwhile", "then", "endif", "read", "write", "return", "call", "record", "endrecord", "else"};
